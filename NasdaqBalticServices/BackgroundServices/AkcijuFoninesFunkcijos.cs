...
{
   public class AkcijuFoninesFunkcijos
    {
        ...
        public AkcijuFoninesFunkcijos()
        {
            GautiAkcijuSarasa();
            IrasytiNaujasAkcijas();
            IrasytiNaujaFinansineInformacija();
            PapildomosInformacijosAtnaujinimas();
        }

        public void PapildomosInformacijosAtnaujinimas()
        {
            List<PapildomaInformacija> NaujPapildomaInformacija = GautiPapildomaInformacija();
        ...
        private List<PapildomaInformacija> GautiPapildomaInformacija()
        {
        ...
        public void IrasytiNaujasAkcijas()
        {
            ...
            List<Akcijos> AtnaujintosAkcijos = new List<Akcijos>();
                foreach (Akcijos akcija in visosAkcijos)
                {
            ...
            {
                Akcijos arYraAkcija = visosAkcijos.Find(x => x.AkcijosKodas == akcija.AkcijosKodas);
                if (arYraAkcija == null)
                    dAL.Istrinti(akcija);
            }
        ...
        public void IrasytiNaujaFinansineInformacija()
        {
            foreach (Akcijos akcija in visosAkcijos)
            {
